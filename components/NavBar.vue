...
const links = [
    ...
    { label: 'Pokemon By Moveset', to: '/PokemonByMoveset' },
...
<template>
    <nav class="w-full p-2 shadow-md">
        <UContainer>
            <UButton v-for="link in links" :key="link.label" :to="link.to" :target="link.target" class="m-1">
                {{ link.label }}
            </UButton>
        </UContainer>
    </nav>
